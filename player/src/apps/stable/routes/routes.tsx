...
export const STABLE_APP_ROUTES: RouteObject[] = [
    {
        ...
        children: [
            {
                // Umbry account gate — required on ALL layouts. The stable app serves tv/desktop/mobile
                // whenever an explicit layout is selected; mirror the experimental app's gate so those
                // clients (notably TV) authenticate to the Umbry backend and sync servers/settings.
