...
import { renderJpxDetailHeader } from 'apps/experimental/theme/jpxDetailHeader';
...
function reloadFromItem(instance, page, params, item, user) {
    ...
    // Umbry: build the Moonfin-style custom detail header (mobile). Deferred so async button
    // setup (playstate/rating/more-commands) has settled before we mirror the buttons.
    setTimeout(() => renderJpxDetailHeader(page, item, apiClient), 60);
