...
import { initJpxVideoOsd } from 'components/jpxVideoOsd';
...
export default function (view) {
    ...
    // Umbry: Moonfin-style OSD skin (reparents the stock transport, adds the icon bar + sheets)
    initJpxVideoOsd(view, () => currentPlayer);
