...
export default class ConnectionManager {
    constructor(credentialProvider, appName, appVersion, deviceName, deviceId, capabilities) {
        ...
        // Umbry standalone client: lowered from the SDK MINIMUM_VERSION (10.10.0) so we can
        // also connect to Emby servers (which version as 4.x) and older Jellyfin servers.
        self._minServerVersion = '3.0.0';
